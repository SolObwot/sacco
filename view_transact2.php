...
$qry1 = mysql_query("select sum(amount) as tot from transaction where dep_with='Deposit' and accountno='$_GET[accountno]' group by accountno");
if($qry1){
...
$qry = mysql_query("select * from transaction where dep_with='Deposit' and accountno='$_GET[accountno]'");
...
$qry2 = mysql_query("select sum(amount) as tot from transaction where dep_with='Withdrawal' and accountno='$_GET[accountno]' group by accountno");
if($qry2){
...
$qryw = mysql_query("select * from transaction where dep_with='Withdrawal' and accountno='$_GET[accountno]'");
if(mysql_num_rows($qry)>0){
