...
if($_GET[app]){
	mysql_query("update loan_application set approved='Approved' where accountno='$_GET[accountno]'");	
} else {	
}

if($_GET[apps]){
	mysql_query("update loan_application set approved='Rejected' where accountno='$_GET[accountno]'");	
} else {	
}
